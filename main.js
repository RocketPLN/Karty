...
var transf = getRandomInt(4)
var ocena = getRandomInt(9)
var x = getRandomInt(6)
var a = getRandomInt(20)
var b = getRandomInt(18)
var c = getRandomInt(21)

document.write(`Ocena: ${oceny[ocena]}`)

if (transf >= 2) {
document.write(`<br>${transfer[transf]} do:`)
document.write(` ${ligi[x]}<br>`)

if (x == 0 ) {
    document.write(`Klubu: ${angilia[a]}`)
    document.write("<br><img src="+x+".png class='main'>")
}
if (x == 1 ) {
    document.write(`Klubu: ${niemcy[b]}`)
    document.write("<br><img src="+x+".png class='bund'>")
}
if (x == 2 ) {
    document.write(`Klubu: ${francja[a]}`)
    document.write("<br><img src="+x+".png class='main'>")
}
if (x == 3 ) {
    document.write(`Klubu: ${wlochy[a]}`)
    document.write("<br><img src="+x+".png class='main'>")
}
if (x == 4 ) {
    document.write(`Klubu: ${hiszpania[a]}`)
    document.write("<br><img src="+x+".png class='main'>")
}
if (x == 5) {
    document.write(`Klubu: ${reszta[c]}`)
    document.write("<br><img src="+x+".png class='main'>")
}}
else {
    document.write(`<br>${transfer[0]}`)
}